...
\begin{table}[H]
    ...
    \begin{tabular}{l*{9}{S[table-auto-round, table-format=1.2]}}
     \toprule
        ...
        Paragram & 0.78&0.36&0.68&\textbf{0.24}&0.54&\textbf{0.28} & 87.63 & 80.23 & 96.39 \\
        CN & \textbf{0.84}&0.28&0.49&0.26&0.36&0.30 & \\
        men-spr-alpha0-win2 \\
        men-spr-alpha0-win5 \\
        men-rmse-alpha0-win2 \\
        men-rmse-alpha0-win5 \\
        men-rmse-alpha1-win2 \\
        men-rmse-alpha1-win5 \\
        men-both-alpha0-win2 \\
        men-both-alpha0-win5 \\
        men-both-alpha0-win2-shuffle \\
        men-both-alpha0-win5-shuffle \\
        simlex-spr-alpha0-win2 \\
        simlex-spr-alpha0-win5 \\
        simlex-rmse-alpha0-win2 \\
        simlex-rmse-alpha0-win5 \\
        simlex-rmse-alpha1-win2 \\
        simlex-rmse-alpha1-win5 \\
        simlex-both-alpha0-win2 \\
        simlex-both-alpha0-win5 \\
        simlex-both-alpha0-win2-shuffle \\
        simlex-both-alpha0-win5-shuffle \\
        simverb-spr-alpha0-win2 \\
        simverb-spr-alpha0-win5 \\
        simverb-rmse-alpha0-win2 \\
        simverb-rmse-alpha0-win5 \\
        simverb-rmse-alpha1-win2 \\
        simverb-rmse-alpha1-win5 \\
        simverb-both-alpha0-win2 \\
        simverb-both-alpha0-win5 \\
        simverb-both-alpha0-win2-shuffle \\
        simverb-both-alpha0-win5-shuffle \\
     \bottomrule
    \end{tabular}
    }
