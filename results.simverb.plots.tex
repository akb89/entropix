  ...
  \resizebox{\linewidth}{!}{
   \begin{tikzpicture}
    \begin{axis}[
     ...
     \addplot [color=blue, mark=none] table[x expr=\coordindex+1,y index=0] {logs/enwiki.20190120.mincount-300.win-5.ppmi.k10000.simverb.sampledims.metric-both.mode-seq.niter-2.start-0.end-0.timestamp-1567965996.883131.kfold1-5.train.spr.log};
     \addlegendentry{fold1-train};
     \addplot [color=red, mark=none] table[x expr=\coordindex+1,y index=0] {logs/enwiki.20190120.mincount-300.win-5.ppmi.k10000.simverb.sampledims.metric-both.mode-seq.niter-2.start-0.end-0.timestamp-1567965996.883131.kfold1-5.test.spr.log};
     \addlegendentry{fold1-test};
     \addplot [color=green, mark=none] table[x expr=\coordindex+1,y index=0] {logs/enwiki.20190120.mincount-300.win-5.ppmi.k10000.simverb.sampledims.metric-both.mode-seq.niter-2.start-0.end-0.timestamp-1567965996.883131.kfold5-5.train.spr.log};
     \addlegendentry{fold5-train};
     \addplot [color=orange, mark=none] table[x expr=\coordindex+1,y index=0] {logs/enwiki.20190120.mincount-300.win-5.ppmi.k10000.simverb.sampledims.metric-both.mode-seq.niter-2.start-0.end-0.timestamp-1567965996.883131.kfold5-5.test.spr.log};
     \addlegendentry{fold5-test};
    \end{axis}
   \end{tikzpicture}
  }
  ...
  \resizebox{\linewidth}{!}{
   \begin{tikzpicture}
    \begin{axis}[
     ...
     \addplot [color=blue, mark=none] table[x expr=\coordindex+1,y index=0] {logs/enwiki.20190120.mincount-300.win-5.ppmi.k10000.simverb.sampledims.metric-both.mode-seq.niter-2.start-0.end-0.timestamp-1567965996.883131.kfold1-5.train.rmse.log};
     \addlegendentry{fold1-train};
     \addplot [color=red, mark=none] table[x expr=\coordindex+1,y index=0] {logs/enwiki.20190120.mincount-300.win-5.ppmi.k10000.simverb.sampledims.metric-both.mode-seq.niter-2.start-0.end-0.timestamp-1567965996.883131.kfold1-5.test.rmse.log};
     \addlegendentry{fold1-test};
     \addplot [color=green, mark=none] table[x expr=\coordindex+1,y index=0] {logs/enwiki.20190120.mincount-300.win-5.ppmi.k10000.simverb.sampledims.metric-both.mode-seq.niter-2.start-0.end-0.timestamp-1567965996.883131.kfold5-5.train.rmse.log};
     \addlegendentry{fold5-train};
     \addplot [color=orange, mark=none] table[x expr=\coordindex+1,y index=0] {logs/enwiki.20190120.mincount-300.win-5.ppmi.k10000.simverb.sampledims.metric-both.mode-seq.niter-2.start-0.end-0.timestamp-1567965996.883131.kfold5-5.test.rmse.log};
     \addlegendentry{fold5-test};
    \end{axis}
   \end{tikzpicture}
  }
